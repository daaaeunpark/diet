document.addEventListener('DOMContentLoaded', function() {
    const addButton = document.getElementById('lunchAddButton');
    const menuInput = document.getElementById('lunchMenuInput');
    const menuList = document.getElementById('lunchMenuList');
    ...
    function loadMenuItems() {
        const savedMenuItems = localStorage.getItem('lunchMenuItems');
        if (savedMenuItems) {
    ...
    function updateChart() {
        ...
        const ctx = document.getElementById('lunchCaloriesChart').getContext('2d');
        new Chart(ctx, {
            type: 'line',
            data: {
                labels: chartLabels,
