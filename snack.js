document.addEventListener('DOMContentLoaded', function() {
    const addButton = document.getElementById('snackAddButton');
    const menuInput = document.getElementById('snackMenuInput');
    const menuList = document.getElementById('snackMenuList');
    ...
    function saveMenuItems() {
        ...
        localStorage.setItem('snackMenuItems', JSON.stringify(menuItems));
    }

    function loadMenuItems() {
        const savedMenuItems = localStorage.getItem('snackMenuItems');
        if (savedMenuItems) {
    ...
    function updateChart() {
        ...
        const ctx = document.getElementById('snackCaloriesChart').getContext('2d');
        new Chart(ctx, {
            type: 'line',
            data: {
                labels: chartLabels,
